...
export function CoworkPinnedSection({ frame, onAction, onNavigate, selectedSessionId, sessions }: CoworkPinnedSectionProps) {
  ...
  return (
    <section className="group/section flex flex-col gap-px" data-cowork-sidebar-section="pinned" data-kind="cowork" data-over={drop.dragOver || undefined} {...drop.sectionProps}>
